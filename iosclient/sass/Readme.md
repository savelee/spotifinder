...
folder are mapped to the application's root namespace, 'SpotifinderIos'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SpotifinderIos"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SpotifinderIos' in the same way
as `"SpotifinderIos/sass/src"`.
