...
folder are mapped to the application's root namespace, 'SpotifinderAndroid'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "SpotifinderAndroid"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'SpotifinderAndroid' in the same way
as `"SpotifinderAndroid/sass/src"`.
