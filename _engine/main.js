...
//const mainStub = require('./electron/processes');
...
//collective contract number, opvragen bij google - collectieviteit gaat dan in op 9 jan
//aanmelde
//zorg.polis@amersoorftse
//collectief nummer
//kan via de website
//voor 31 dec zilveren kruis opzeggen
...
function createWindow () {
    ...
    win = new BrowserWindow({
        width: initData.width || 1000,
        height: initData.height || 600,
        x: initData.x,
        y: initData.y,
